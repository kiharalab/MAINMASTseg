...
int cmp_edge_d(const void *, const void *);
...
void ShowModelChainCIF(MRC *,POINTS *,GRAPH *);
void ShowModelChainCIF_Movie(MRC *,POINTS *,GRAPH *);

bool GenerateSegmentMrc(MRC *,POINTS *,GRAPH *);
bool write_mrc(MRC *,char *);
